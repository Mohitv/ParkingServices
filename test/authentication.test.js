...
describe('Authentication Tests', () => {
  describe('Sign up new user API-"/signup" Request type - "POST"', () => {
    beforeEach((done) => {
      ...
      it('Return status code 200 if user is added to Users collections', (done) => {
        ...
        it('Return status code 423 when user already exists', (done) => {
          chai.request(server)
              .post('/signup')
              .send(testData)
              .end((err, res) => {
        ...
        it('Sign in with this user', (done) => {
          chai.request(server)
              .post('/signin')
              .send(testData)
              .end((err, res) => {
